...
ExecSWDL(assembly)
{
	...
	Sleep, 2000  ; 2 second
	Send, %A_ScriptDir%\IVS Submission\%assembly%_SWDL.txt{Enter}
	...
	Sleep, 2000  ; 2 second
	Send, %A_ScriptDir%\IVS Submission\%assembly%{Enter}
	Sleep, 5000  ; 5 seconds to accomodate potential errors popping up
	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;Check for Runtime errors when opening the SWDL file
	IfWinExist, Runtime errors
		{
			WinClose, Runtime errors ; use the window found above
			MouseClick, left, 450,75
			Sleep, 2000  ; 2 second
	...
	Loop, Parse, FileList, `n
	{
		...
		If InStr(file_var, nvh)
			If InStr(file_var, eq)
				...
				{
					FileMove, C:\Users\gtsirov\Documents\SnapShot\Logs\%A_LoopField%, %A_ScriptDir%\IVS Submission\%assembly%_Snapshot.txt
